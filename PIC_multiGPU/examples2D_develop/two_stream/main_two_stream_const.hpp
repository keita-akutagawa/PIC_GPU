...
#include <iomanip>
#include <cmath>
#include "../../PIC2D_multiGPU_develop/pic2D.hpp"
#include "../../PIC2D_multiGPU_develop/mpi.hpp"
#include <cuda_runtime.h>


std::string directoryname = "/cfca-work/akutagawakt/PIC_multiGPU/results_two_stream";
std::string filenameWithoutStep = "two_stream";
std::ofstream logfile("/cfca-work/akutagawakt/PIC_multiGPU/results_two_stream/log_two_stream.txt");
std::ofstream mpifile("/cfca-work/akutagawakt/PIC_multiGPU/results_two_stream/mpi_two_stream.txt");
...
const float xmax = nx * dx - 0.0f;

const int ny = 8;
const float dy = 1.0f;
const float ymin = 0.0f; 
const float ymax = ny * dy - 0.0f;
