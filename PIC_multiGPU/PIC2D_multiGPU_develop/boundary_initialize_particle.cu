...
)
{
    ...
    thrust::device_vector<Particle> recvParticlesSpeciesLeft(numForRecvParticlesSpeciesLeft);
    thrust::device_vector<Particle> recvParticlesSpeciesRight(numForRecvParticlesSpeciesRight);
    ...
    for (unsigned int i = 0; i < numForRecvParticlesSpeciesLeft; i++) {
        particlesSpecies[existNumSpecies + i] = recvParticlesSpeciesLeft[i];
    }
    existNumSpecies += numForRecvParticlesSpeciesLeft;
    for (unsigned int i = 0; i < numForRecvParticlesSpeciesRight; i++) {
        particlesSpecies[existNumSpecies + i] = recvParticlesSpeciesRight[i];
    }
...
)
{
    ...
    thrust::device_vector<Particle> recvParticlesSpeciesDown(numForRecvParticlesSpeciesDown);
    thrust::device_vector<Particle> recvParticlesSpeciesUp(numForRecvParticlesSpeciesUp);
    sendrecv_particle_y(
    ...
    for (unsigned int i = 0; i < numForRecvParticlesSpeciesDown; i++) {
        particlesSpecies[existNumSpecies + i] = recvParticlesSpeciesDown[i];
    }
    existNumSpecies += numForRecvParticlesSpeciesDown;
    for (unsigned int i = 0; i < numForRecvParticlesSpeciesUp; i++) {
        particlesSpecies[existNumSpecies + i] = recvParticlesSpeciesUp[i];
    }
