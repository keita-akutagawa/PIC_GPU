...
dx = 1.0
dy = 1.0
n_x = int(ion_inertial_length * 50.0)
...
dirname = "/cfca-work/akutagawakt/PIC/results_mr_small_guide"
savedir = "pictures_mr"
...
start_y_enlarged = np.arange(-5, 5, 1)
...
for step in range(0, 0+1, 1000):
    ...
    #mappable = ax1.pcolormesh(X, Y, E[2] / B0 / V_Ai, cmap='jet', vmin=-0.2, vmax=0.2)
    #if step == 0:
